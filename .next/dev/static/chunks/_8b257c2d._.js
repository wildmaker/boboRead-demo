...
function ReadPage() {
    ...
    const [voiceRole, setVoiceRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("小狐狸");
        ...
        "ReadPage.useEffect": ()=>{
            if (showVoiceDrawer && wheelRef.current) {
                ...
                setTimeout({
                    "ReadPage.useEffect": ()=>{
                        handleScroll();
                        const index = voiceOptions.findIndex({
                            "ReadPage.useEffect.index": (v)=>v.label === voiceRole
                        }["ReadPage.useEffect.index"]);
                ...
                }["ReadPage.useEffect"], 100);
                const wheel = wheelRef.current;
                let ticking = false;
                const onScroll = {
                    "ReadPage.useEffect.onScroll": ()=>{
                        if (!ticking) {
                ...
                return ({
                    "ReadPage.useEffect": ()=>wheel.removeEventListener('scroll', onScroll)
                })["ReadPage.useEffect"];
            }
        }
    }["ReadPage.useEffect"], [
...
_s(ReadPage, "q2/FrlTHnYNhJfWXEBaOh0kh8QU=", false, function() {
    return [
...
//# sourceMappingURL=_8b257c2d._.js.map